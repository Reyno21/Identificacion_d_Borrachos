...
face_cascade = cv2.CascadeClassifier('C://Users//Reyno21//OneDrive//Escritorio//Escuela//Tratamiento de Imagenes//Clases//Rostros//haarcascade_frontalface_default.xml') #Cargar el archivo de cascada para reconocer la cara
eye_casade = cv2.CascadeClassifier('C://Users//Reyno21//OneDrive//Escritorio//Escuela//Tratamiento de Imagenes//Clases//Rostros//haarcascade_eye.xml') #Cargar el archivo de cascada para reconocer los ojos

img = cv2.imread('C://Users//Reyno21//OneDrive//Escritorio//Escuela//Tratamiento de Imagenes//Clases//Imagenes//b5b68253409b796f61f6ecd1f1.jpg')
